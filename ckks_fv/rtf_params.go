...
var HeraModDownParams80 = [][]int{
	...
	{7, 2, 2, 3, 3, 3}, // with RtF param 128-h
}
...
var HeraModDownParams128 = [][]int{
	...
	{5, 2, 2, 2, 2, 3}, // with RtF param 128h
	{7, 2, 2, 3, 3, 3}, // with RtF param 128-9
}
...
var RtFParams = []*HalfBootParameters{
	...
	// 128h
	// Use full slots but not full coefficients for data encoding
	{
		LogN:     16,
		LogSlots: 15,
		Scale:    1 << 40,
